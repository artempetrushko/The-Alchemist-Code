...
public class SimpleItemCellContainer : ItemCellContainer
{
    public override void OnDrop(PointerEventData eventData)
    {
        ...
        {          
            ...
            {
                var draggingItemStartContainer = draggingItem.GetComponent<InventoryItemDrag>().StartParent.GetComponentInParent<ItemCellContainer>();
                switch (draggingItemStartContainer)
                {
                    case WeaponSetItemCellContainer:
                        if (!(ContainedItem.ItemState is WeaponState))
                        {
                            return;
                        }
                        break;
                    ...
                    case EquipmentItemCellContainer:
                        if (!(ContainedItem.ItemState is ClothesState) || (ContainedItem.ItemState as ClothesState).ClothesType != (draggingItemStartContainer as EquipmentItemCellContainer).RequiredClothesType)
                        {
                            return;
                        }
                        break;
